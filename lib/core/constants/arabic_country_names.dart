...
abstract class ArabicCountryNames {
  ...
  /// Arabic translations for language names
  static const Map<String, String> languages = {
    ...
    'Papiamento': 'البابيامنتو',
    'Sranan Tongo': 'السرانان تونغو',
    ...
    // Sign languages (often mentioned)
    'Sign Language': 'لغة الإشارة',
  };

  /// Arabic translations for currency names
  static const Map<String, String> currencies = {
    ...
    'Ethiopian birr': 'البير الإثيوبي',
    'Tanzanian shilling': 'الشلن التنزاني',
    'Ugandan shilling': 'الشلن الأوغندي',
    'CFA franc': 'الفرنك الأفريقي',
    'West African CFA franc': 'فرنك غرب أفريقيا',
    'Central African CFA franc': 'فرنك وسط أفريقيا',
    'Mauritian rupee': 'الروبية الموريشيوسية',
    'Seychellois rupee': 'الروبية السيشلية',
    'Malagasy ariary': 'الأرياري الملغاشي',
    'Zambian kwacha': 'الكواشا الزامبية',
    'Botswana pula': 'البولا البوتسوانية',
    'Namibian dollar': 'الدولار الناميبي',
    'Swazi lilangeni': 'الليلانجيني السوازيلندي',
    'Rwandan franc': 'الفرنك الرواندي',
    'Burundian franc': 'الفرنك البوروندي',
    'Djiboutian franc': 'الفرنك الجيبوتي',
    'Comorian franc': 'الفرنك القمري',
    'Somali shilling': 'الشلن الصومالي',
    'Eritrean nakfa': 'الناكفا الإريترية',
    'South Sudanese pound': 'الجنيه الجنوب سوداني',

    // Asian currencies
    'Hong Kong dollar': 'دولار هونغ كونغ',
    'Singapore dollar': 'الدولار السنغافوري',
    'New Taiwan dollar': 'دولار تايوان الجديد',
    ...
    'Vietnamese đồng': 'الدونغ الفيتنامي',
    ...
    'Burmese kyat': 'الكيات البورمي',
    'Cambodian riel': 'الريال الكمبودي',
    'Lao kip': 'الكيب اللاوي',
    'Mongolian tögrög': 'التوغريك المنغولي',
    'Bhutanese ngultrum': 'النغولتروم البوتاني',
    'Maldivian rufiyaa': 'الروفيا المالديفية',
    'Afghan afghani': 'الأفغاني الأفغاني',
    'Kazakhstani tenge': 'التينغي الكازاخستاني',
    'Uzbekistani soʻm': 'السوم الأوزبكستاني',
    'Tajikistani somoni': 'السوموني الطاجيكي',
    'Kyrgyzstani som': 'السوم القيرغيزي',
    'Turkmenistani manat': 'المانات التركمانستاني',
    'Azerbaijani manat': 'المانات الأذربيجاني',
    'Georgian lari': 'اللاري الجورجي',
    'Armenian dram': 'الدرام الأرميني',
    'North Korean won': 'الوون الكوري الشمالي',
    'Macanese pataca': 'الباتاكا الماكاوية',
    'Brunei dollar': 'الدولار البروناوي',

    // European currencies (non-Euro)
    'Polish złoty': 'الزلوتي البولندي',
    'Czech koruna': 'الكورونا التشيكية',
    'Hungarian forint': 'الفورنت المجري',
    'Romanian leu': 'الليو الروماني',
    'Bulgarian lev': 'الليف البلغاري',
    'Croatian kuna': 'الكونا الكرواتية',
    'Serbian dinar': 'الدينار الصربي',
    'Macedonian denar': 'الدينار المقدوني',
    'Albanian lek': 'الليك الألباني',
    'Bosnian convertible mark': 'المارك البوسني',
    'Moldovan leu': 'الليو المولدوفي',
    'Ukrainian hryvnia': 'الهريفنيا الأوكرانية',
    'Belarusian ruble': 'الروبل البيلاروسي',
    'Swedish krona': 'الكرونة السويدية',
    'Norwegian krone': 'الكرونة النرويجية',
    'Danish krone': 'الكرونة الدنماركية',
    'Icelandic króna': 'الكرونة الآيسلندية',
    'Faroese króna': 'الكرونة الفاروية',
    'Gibraltar pound': 'جنيه جبل طارق',
    'Jersey pound': 'جنيه جيرزي',
    'Guernsey pound': 'جنيه غيرنزي',
    'Manx pound': 'جنيه جزيرة مان',
    ...
    'Bolivian boliviano': 'البوليفيانو البوليفي',
    'Paraguayan guaraní': 'الغواراني الباراغوياني',
    'Uruguayan peso': 'البيزو الأوروغوياني',
    'Venezuelan bolívar': 'البوليفار الفنزويلي',
    'Guyanese dollar': 'الدولار الغياني',
    'Surinamese dollar': 'الدولار السورينامي',
    'Cuban peso': 'البيزو الكوبي',
    'Dominican peso': 'البيزو الدومينيكاني',
    'Haitian gourde': 'الغورد الهايتي',
    ...
    'Belize dollar': 'الدولار البليزي',
    'Eastern Caribbean dollar': 'دولار شرق الكاريبي',
    'Guatemalan quetzal': 'الكيتزال الغواتيمالي',
    'Honduran lempira': 'الليمبيرا الهندوراسية',
    'Nicaraguan córdoba': 'الكوردوبا النيكاراغوية',
    'Costa Rican colón': 'الكولون الكوستاريكي',
    'Panamanian balboa': 'البالبوا البنمي',
    'Netherlands Antillean guilder': 'الغيلدر الأنتيلي الهولندي',
    'Aruban florin': 'الفلورين الأروبي',
    ...
    'Papua New Guinean kina': 'الكينا البابوية',
    'Samoan tālā': 'التالا الساموية',
    'Tongan paʻanga': 'البانغا التونغي',
    'Vanuatu vatu': 'الفاتو الفانواتي',
    'Solomon Islands dollar': 'دولار جزر سليمان',
    'CFP franc': 'الفرنك الباسيفيكي',
    'Cook Islands dollar': 'دولار جزر كوك',
    'Kiribati dollar': 'دولار كيريباتي',
